...
IMPORTANT: end by calling final_answer(<the_list>).""".format(k=int(top_k))
    ...
    if backend != "smolagents":
        ...
        task = (
            ...
            "Return the list via final_answer: either call final_answer(<list>) or assign final_answer = <list>.\n"
            "Example value: [{{'kind':'cross_bridge','source':'term_a','target':'term_b','predicate':'may_relate_to','score':1.23,'graph_signals':{{'adamic_adar':1.23}}}}]\n"
